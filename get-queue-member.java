 ...
 * 5. RUN CURL COMMAND TO GET LIST OF QUEUE MEMBERS:
 ...
 * 7. RUN CURL COMMAND TO GET QUEUE MEMBER:
      `curl {baseUrl}/getQueueMember  -d 'queueId={queueId}&callId={callId}'`
 ...
 *    {"uri":"/Accounts/{accountId}/Queues/{queueId}/Members/{callId}",
        ...
        "position":{position},
        "dateEnqueued":"{dateEnqueued}"}
 * 9. Then you may hangup the phone, which will delete the queue since it is empty
*/

package main.java.get_queue_member;
